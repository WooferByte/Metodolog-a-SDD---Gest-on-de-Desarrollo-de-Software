...
## Purpose
Defines standardized HTTP error responses following RFC 7807 (Problem Details for HTTP APIs) for the Food Store backend. All error responses SHALL use the Problem+JSON format and `Content-Type: application/problem+json`.
